...
if hasattr(select, 'select'):
    class SelectSelector(BaseSelector):
        ...
        def check_is_ready_for_command(self, timeout):
            ...
            otherwise False.
            """
            # TODO 在<timeout>秒内，从传递的参数list中返回readable，writable，exception的socket list
            # TODO The return value is a triple of lists of objects that are ready: subsets of the first three arguments.
